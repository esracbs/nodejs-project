...
class AuditLogs{
    ...
    #saveToDB({level,email,location,proc_type,log}){//# bu metodu sadece bulunulan classta erişilebilir yapıyor. private gibi
        AuditLogsModel.create({ //buraya wait yazmadık çünkü veritabanına her log basmada kayıt işlemini beklemek istemiyoruz
